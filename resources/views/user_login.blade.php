...
@section('content')
    ...
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
        <div class="w-100" style="max-width: 500px;">
            <form action="{{route('user_login.post')}}" method="POST" class="mt-3">
                @csrf
                ...
                <a class="btn btn-registration w-100 mb-3" style="border-radius: 20px; height: 40px; font-size: 13px; border: 1px solid #ccc;" href="{{route('user_registration')}}">Sign Up</a>
                <p class="mb-3 text-center">Are you a merchant?</p>
                <a class="btn btn-merchant w-100" style="border-radius: 20px; height: 40px; font-size: 13px; background-color: #109908; color: white;" href="{{route('merchant_login')}}">Merchant Login</a>
            </form>
            @if($errors->any())
                <div class="col-12">
